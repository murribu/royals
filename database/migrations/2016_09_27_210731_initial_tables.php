...
class InitialTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('pfx_pitches', function (Blueprint $table) {
            ...
            $table->integer('batter_mlb_id')->unsigned();
            $table->foreign('batter_mlb_id')->references('mlb_id')->on('players');
            $table->string('pitcher_name');
            $table->integer('pitcher_mlb_id')->unsigned();
            $table->foreign('pitcher_mlb_id')->references('mlb_id')->on('players');
